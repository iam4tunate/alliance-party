          ...
          <div className="py-5 px-4 max-sm:px-2">
            ...
            <div className="pt-3 max-sm:text-lg leading-normal text-secondary">
              <p className="pb-2">
                ...
                founded with a vision to emerge as a preeminent political
                pressure group, offering crucial support to candidates and
                political parties.
              </p>
              <p className="pb-2">
                ...
                allowing people to choose their leaders. In line with our
                mission, our communications focus on socio-economic, political,
                and developmental issues.
              </p>
              <p>
                We uphold a standard of mutual respect, requiring all posts and
                comments to align with the group's values and refrain from
                insults or abuses in any form. New members are encouraged to
                register themselves in other to become a verified member.
              </p>
            </div>
          </div>
        </div>
