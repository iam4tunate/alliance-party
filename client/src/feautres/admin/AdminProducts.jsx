...
import { BiChevronsRight, BiSolidEditAlt, BiTrash } from 'react-icons/bi';
import { Link } from 'react-router-dom';
import { useDispatch, useSelector } from 'react-redux';
import { deleteProduct, setProducts } from '../slices/productSlice';
  ...
  return (
    <div className='body-content px-8 py-8 bg-slate-100'>
      <div className='page-title mb-10'>
        <div className='mb-1 text-[26px] font-Heebo500'>Products</div>
        <ul className='text-xs font-Heebo500 flex items-center space-x-1'>
          ...
          <BiChevronsRight />
          <li className='text-muted'>Product List</li>
        </ul>
      </div>
      ...
      <div className='bg-white rounded-t-md rounded-b-md shadow-xs py-4'>
        ...
        <div className='flex items-center justify-between px-8 py-8'>
          ...
          <Link
            ...
            className='bg-green text-white py-3 px-4 flex items-center gap-x-2 rounded-md text-sm font-Heebo600'
          >
