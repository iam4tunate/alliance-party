  ...
  return (
    <div className="w-full">
      ...
      <div
        ...
        className="bg-cover bg-center bg-no-repeat min-h-screen flex items-center justify-center text-white text-center py-12 px-8 fixed top-0 right-0 bottom-0 w-1/2"
      >
