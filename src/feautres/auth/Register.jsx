...
const Register = () => {
  ...
  return (
    <div className="relative text-base">
      {isRegistered && (
        <div className="w-1/2 h-screen px-8 py-12 fixed top-0 left-0 bottom-0 bg-[rgba(0,0,0,0.8)] flex items-center">
          <div className="flex flex-col text-center items-center gap-y-2 w-[80%] mx-auto bg-white rounded-md py-6 px-6">
      ...
      <div className="text-black px-8 py-12">
        <div className="pb-10 flex items-center justify-between">
          ...
          <Link to="/">
            <span className="text-sm text-secondary font-Heebo500 flex items-center gap-x-2">
        ...
        <form className="grid grid-cols-2 gap-x-6 gap-y-8">
          ...
          <div
            ...
            className="bg-primary text-white py-3 px-10 col-start-1 col-end-3 w-fit justify-self-center rounded-md cursor-pointer"
          >
            Register
          </div>
        </form>
